...
**React Practice** is a project on understanding and practicng the use of React in developing projects.
...
```sh
  cd my-folder
  git clone https://github.com/davidolanrewaju/ReactPractice.git
```
...
Feel free to check the [issues page](https://github.com/davidolanrewaju/ReactPractice/issues).
...
I would like to thank Microverse for the resources provided to make this project easy to execute.
...
- **How did you set up your project?**
  ...
  - Installed all project dependencies (stylelint, webhint, lighthouse)

- **How do I clone your report for use?**

  - Open git bash and enter "git clone https://github.com/davidolanrewaju/ReactPractice.git"
